...
<div class="site-wrap min-h-screen flex flex-col pt-10">
    <header class="top-bar fixed top-0 bg-gray-800 inset-x-0 text-white h-10">
        <div class="container mx-auto h-full flex">
            <a href="/" class="top-bar__logo px-5 flex items-center">
                <span><i class="fas fa-fan"></i></span>
                <span class="ml-2 font-bold hidden sm:inline">SUBIN IT</span>
            </a>
